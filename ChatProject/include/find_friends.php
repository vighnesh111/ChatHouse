...
<head>
    ...
    <title>ChatProject-Search for friends</title>
    <link href="../css/find_people.css" rel="stylesheet" type="text/css">
    ...
    <div class="row">
        ...
        <div class="col-sm-4">
            <form class="search_form" action="">
                ...
                <button class="btn" type="submit" name="search_btn"></button>
            </form>
        </div>
        <div class="col-sm-4">
        </div>
