...
<head>
    ...
    <title>ChatProject-Account Settings</title>
            ...
            <form action="" method="post" enctype="multipart/form-data" >
                <table class="table table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="u_name" class="form_control" required value="<?php echo $user_name; ?>">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="email" name="u_email" class="form_control" required value="<?php echo $user_email; ?>">
                        </td>
                    </tr>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="recovery.php?id=<?php echo $user_id; ?>" method="post" id="f">
                                                <strong>
                                                    What is your school bestfriend name?
                                                </strong>
                                                ...
                                                <pre>
                                                    Answer the above question. We will ask you this question if you forgot your <br>Password.
                                                </pre><br><br>                        
                                            </form>
                                            <?php 
                                                if(isset($_POST['sub'])){
